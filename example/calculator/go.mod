...
replace github.com/nfwGytautas/mstk/gomods/locator-api => ../../gomods/locator-api
...
require (
	...
	github.com/nfwGytautas/mstk/gomods/api/common-api v0.0.0-00010101000000-000000000000 // indirect
	github.com/nfwGytautas/mstk/gomods/locator-api v0.0.0-00010101000000-000000000000 // indirect
)
